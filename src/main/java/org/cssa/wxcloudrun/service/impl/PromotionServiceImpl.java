...
public class PromotionServiceImpl implements PromotionService {
     ...
     */
    @Override
    public Response<List<Promotion>> getOngoingMainPromotions(Integer type){
        return new Response<>(promotionMapper.getOngoingMainPromotions(type));
    }
    ...
    public Response<List<Promotion>> getOngoingPagePromotions() {
        return new Response<>(promotionMapper.getOngoingPagePromotions());
    }
}